...
export default function MentionsLegales() {
  return (
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", color: "#fff", padding: "3rem 1rem",   width: "90vw", maxWidth: "50vw", height: "90vh"}}>
    <NavbarReglement />
    <StarBackground />
      ...
      <p>
        ...
        Site réalisé par <a href="https://www.linkedin.com/in/sacha-desquesnes-123456789/" style={{ fontWeight: "bold", color: "#fff", textDecoration: "none" }}>Sacha DESQUESNES</a> pour la communauté Ecarlate RP.
      </p>
      {/*<p>
